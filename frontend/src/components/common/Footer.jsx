    ...
    <div className="bg-richblack-800 mx-7 rounded-3xl mb-10">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[35%] flex flex-col gap-3 lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 mb-7 lg:mb-0">
            <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-yellow-25 via-yellow-100 to-yellow-50 bg-clip-text text-transparent tracking-wider">
              CampusSphere
            </Link>
            <h1 className="text-richblack-50 font-semibold text-[16px]">UVCE Campus</h1>
            <div className="flex flex-col gap-1 text-[14px]">
              <p>K.R. Circle, Bengaluru,</p>
              <p>Karnataka 560001</p>
              <p className="text-yellow-50 mt-1">support@campussphere.edu</p>
            </div>
            {/* social icons */}
          ...
          {/* Section 2 - Institutional Link Columns */}
          <div className="lg:w-[65%] flex flex-wrap flex-row justify-between pl-3 lg:pl-10 gap-3">
            {FooterLink2.map((ele, i) => {
              return (
                <div key={i} className="w-[45%] md:w-[30%] mb-7 lg:pl-0">
