            ...
            <div className="my-4 flex h-[450px] space-x-4">
              ...
              <div className="flex min-w-[250px] flex-col rounded-md bg-richblack-800 p-6">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div>
                    <p className="text-lg text-richblack-200">Total Enrolled Undergraduates</p>
                    <p className="text-3xl font-semibold text-richblack-50">
                      {totalStudents}
                    </p>
                  </div>
                  <div>
                    <p className="text-lg text-richblack-200">Average Class Attendance Rate</p>
                    <p className="text-3xl font-semibold text-richblack-50 text-caribbeangreen-100">
                      87.4%
                    </p>
                  </div>
                  <div>
                    <p className="text-lg text-richblack-200">Labs Submitted</p>
                    <p className="text-3xl font-semibold text-richblack-50 text-yellow-100">
                      142
                    </p>
                  </div>
                </div>
                  ...
                  <div key={course._id} className="sm:w-1/3 flex flex-col items-center justify-center">
                    ...
                    <div className="mt-3 w-full">
                      ...
                      <div className="mt-1 flex items-center space-x-2">
                        ...
                        <p className="text-xs font-medium text-richblack-300">
                          Sem {course.semester} ({course.classSection})
                        </p>
                      </div>
                    </div>
                  </div>
